...
- [config_linkedin_auto.yaml](config_linkedin_auto.yaml)：推荐版，适合大多数人
- [config_linkedin_auto_ssh22_redir.yaml](config_linkedin_auto_ssh22_redir.yaml)：仅在 GitHub SSH 22 端口异常时使用
